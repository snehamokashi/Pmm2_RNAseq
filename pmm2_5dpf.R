...
combined_counts<-as.data.frame(combined_counts_5dpf)
...
summary(is.de)
volcplot<-plotMD(res,status = is.de,values=c(1,-1),col=c("blue","red"),legend="topright", main="Pmm2: Mutant vs WT 5dpf", bg.pch=1, hl.pch=20)
volcplot
...
Hom_vs_WT_output <- topTags(res,n=20233)
write.csv(Hom_vs_WT_output,file="Hom_vs_WT_Pmm2_5dpf_2_23_23.csv")
